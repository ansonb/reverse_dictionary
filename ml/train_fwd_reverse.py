...
with open('../data/sample/dictionary_end2end.json', 'w') as f:
...
word_count = 0
# max_word_count = 1
for word,def_arr in data_json.items():
	# #train only first max_words number of words
...
def get_training_data(in_token_arr,out_arr,out_token_arr):
	inp = []
	out = []
...
print(NUM_CLASSES)
training_in_data, training_out_data = get_training_data(in_token_arr,out_arr,out_token_arr)
...
# with open('../data/training_negatives.txt', 'w') as f:
# 	json.dump(negatives_data,f,indent=4)
